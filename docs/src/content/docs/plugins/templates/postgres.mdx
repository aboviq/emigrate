---
title: "PostgreSQL Template Plugin"
---

import { Tabs, TabItem } from '@astrojs/starlight/components';
import Link from '@components/Link.astro';

The PostgreSQL Template Plugin creates new migration files with the `.sql` extension. In the same package you can find the <Link href="/plugins/loaders/postgres/">PostgreSQL Loader Plugin</Link> and the <Link href="/plugins/storage/postgres/">PostgreSQL Storage Plugin</Link>.
